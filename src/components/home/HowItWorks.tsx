...
const HowItWorks = () => {
    return (
        <>
            ...
            <p className="text-white text-center md:text-left mt-5 mb-5 md:text-xl sm:text-lg">
            ...
            <p className="text-white text-center md:text-left mb-5 md:text-xl sm:text-lg">
            ...
            <p className="text-white text-center md:text-left mb-5 text-xl">
            ...
            <p className="text-white md:text-left text-center mb-10 text-xl">
